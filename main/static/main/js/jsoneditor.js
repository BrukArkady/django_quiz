...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    // If the object should be rendered as a div
      ...
      this.editjson_save = this.getButton('Сохранить','save','Сохранить');
      this.editjson_save.addEventListener('click',function(e) {
        e.preventDefault();
        e.stopPropagation();
        self.saveJSON();
      });
      this.editjson_cancel = this.getButton('Отменить','cancel','Отменить');
      ...
      // Edit JSON Button
      this.editjson_button = this.getButton('JSON','edit','Редактировать JSON');
      ...
      this.addproperty_button = this.getButton('Свойства','edit','Свойства объекта');
...
JSONEditor.defaults.languages.ru = {
  error_notset: "Cвойство должно быть установлено",
  error_notempty: "Требуется значение",
  error_enum: "Значение должно быть одним из перечисленных значений",
  error_anyOf: "Значение должно проверяться по крайней мере одной из предоставленных схем",
  error_oneOf: "Значение должно быть проверено по одной из предоставленных схем. В настоящее время выполняется проверка на соответствие {{0}} схем.",
  error_not: "Значение не должно проверяться по предоставленной схеме",
  error_type_union: "Значение должно соответствовать одному из предоставленных типов",
  error_type: "Значение должно быть типа {{0}}",
  error_disallow_union: "Значение не должно соответствовать запрещенным типам",
  ...
  error_maxLength: "Значение должно быть не более {{0}} символов",
  error_minLength: "Значение должно быть не менее {{0}} символов",
  error_pattern: "Значение должно соответствовать шаблону {{0}}",
  error_additionalItems: "Дополнительные элементы запрещены в этом массиве",
  error_maxItems: "Значение должно иметь не более {{0}} элементов",
  error_minItems: "Значение должно иметь по крайней мере {{0}} элементов",
  error_uniqueItems: "Массив должен иметь уникальные элементы",
  error_maxProperties: "Объект должен иметь не более {{0}} свойств",
  error_minProperties: "Объект должен иметь, по крайней мере, {{0}} свойств",
  error_required: "У объекта пропущенно необходимое свойство '{{0}}'",
  error_additional_properties: "Дополнительные свойства не допускаются, но свойство {{0}} установлено",
  error_dependency: "Должно иметь свойство {{0}}",
  ...
  button_move_down_title: "Вниз",
  button_move_up_title: "Вверх",
